...
#### Take-home message: When recognizing visual text from the low-resource language, use the high-resource language together for better performance.
1. In this work, we investigate **cross-lingual learning (CLL) for multilingual scene text recognition (STR).** <br>
